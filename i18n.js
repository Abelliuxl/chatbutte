...
const translations = {
  zh: {
    ...
    'main.attach': '上传图片/文件',
    'main.mode.chat': '对话',
    'main.mode.image': '生成图片',
    'main.modeStatus.chat': '当前模式：对话',
    'main.modeStatus.image': '当前模式：生成图片',
    'main.attachmentHint': '图片会按多模态消息发送，文本文件会携带内容，其他文件仅发送元信息。',
    'main.imagePlaceholder': '输入图片提示词，可附加文本文件作为参考...',

    // 设置
    'settings.title': '设置',
    'settings.tab.models': '模型',
    'settings.tab.appearance': '外观',
    'settings.tab.send': '发送',
    ...
    'settings.authGroup': '认证信息',
    'settings.authHint': '同一服务商通常对对话和生图共用同一个 API Key。',
    'settings.chatGroup': '对话能力',
    'settings.chatHint': '用于普通对话、看图问答、生成话题名等文本能力。',
    'settings.chatApiUrl': '对话 API 地址',
    'settings.chatModel': '对话模型',
    'settings.imageApiUrl': '图片生成 API 地址',
    'settings.imageApiUrl.placeholder': 'https://api.openai.com/v1/images/generations',
    'settings.imageModel': '图片生成模型',
    'settings.imageModel.placeholder': '留空则默认使用聊天模型',
    'settings.imageGroup': '生图能力',
    'settings.imageHint': '如果服务商区分文生图接口，请单独填写；否则可留空尝试自动推断。',
    'settings.cancel': '取消',
    'settings.save': '保存模型',
    'settings.saveAll': '存储',
    'settings.profileNew': '＋ 新增模型配置',
    'settings.edit': '编辑',
    'settings.delete': '删除',
    'settings.noModel': '未配置模型',
    'settings.profileType': '类型',
    'settings.profileName': '名称',
    'settings.profileName.placeholder': '留空则显示模型名',
    'settings.profileName.desc': '留空则显示模型名',
    'settings.profileName.optional': '可选',
    'settings.gistToken.hintShort': '需要具有 gist 权限的 Token',
    'settings.gistId.hintShort': '首次同步将自动创建',
    'settings.gistId.placeholderShort': '自动创建',
    'settings.syncAction': '手动同步',
    'settings.uploadShort': '上传',
    'settings.downloadShort': '下载',
    'settings.import.desc': '从 JSON 恢复聊天记录与配置',
    'settings.importAction': '选择文件',
    'settings.export.desc': '保存全部数据为 JSON',
    'settings.exportAction': '导出',
    'settings.reset.desc': '清空聊天记录、话题与模型配置',
    'settings.resetAction': '重置',
    'settings.profileFormHint': '每个配置只能选择对话或生图其中一种，保存后在右上角切换使用。',
    'profile.type.chat': '对话',
    'profile.type.image': '生图',
    'profile.incomplete': '当前模型配置不完整，请补全 API 地址和模型。',

    // 发送设置
    'settings.sendConfig': '发送设置',
    'settings.sendKey': '发送按键',
    'settings.sendKey.desc': '选择用哪个快捷键发送消息',
    ...
    'message.error': '出错了：',
    'message.generatingImage': '正在生成图片...',
    'message.imageGenerated': '图片已生成。',
    'message.openImage': '在新标签页查看大图',
    'message.popupBlocked': '浏览器拦截了弹窗，请允许本站打开新标签页后再试。',
    'message.noImagePrompt': '请输入图片提示词，或附加文本文件作为参考。',
    'message.imageEndpointMissing': '当前模型未配置图片生成接口。',
    'message.noChatCapability': '当前模型未配置可用的对话接口。',
    'message.attachReadFailed': '读取附件失败：',
    'message.attachTooMany': '单次最多上传 5 个附件。',
    'message.attachImageTooLarge': '图片过大，请控制在 3MB 以内。',
    'message.attachTextTooLarge': '文本文件过大，请控制在 200KB 以内。',
    'message.attachEmpty': '所选附件为空或无法读取。',
    'message.binaryFileOnlyMeta': '二进制文件仅发送文件名、类型和大小元信息。',
    'message.fileLabel': '文件',
    'message.imageLabel': '图片',
    'message.removeAttachment': '移除附件',
    ...
    'error.imageResponse': '图片生成结果为空，请确认接口是否兼容 OpenAI Images API。',
    'error.profileChatIncomplete': '如果要配置对话能力，需要同时填写对话 API 地址和对话模型。',
    'error.profileImageIncomplete': '如果只配置生图能力，需要同时填写图片生成 API 地址和图片生成模型。',
    'error.profileNeedCapability': '至少需要配置一组完整能力：对话或生图。',
    'error.profileIncomplete': '请填写完整的 API 地址和模型。',
    'error.storageUnavailable': '浏览器无法写入本地存储，刷新后配置和聊天记录会丢失。这是纯静态网站，数据只保存在当前浏览器的 localStorage 中。请通过 https:// 正常访问（不要直接打开本地文件），并确认未开启无痕/禁用 Cookie 模式。',
    'error.storageQuota': '本地存储空间已满，聊天记录未能完整保存。请导出备份后清理旧对话，或减少图片附件。',
  },
  ...
  en: {
    ...
    'main.attach': 'Upload Image/File',
    'main.mode.chat': 'Chat',
    'main.mode.image': 'Generate Image',
    'main.modeStatus.chat': 'Mode: Chat',
    'main.modeStatus.image': 'Mode: Image Generation',
    'main.attachmentHint': 'Images are sent as multimodal input, text files include content, other files send metadata only.',
    'main.imagePlaceholder': 'Describe the image you want. You can attach text files as reference...',

    // Settings
    'settings.title': 'Settings',
    'settings.tab.models': 'Models',
    'settings.tab.appearance': 'Appearance',
    'settings.tab.send': 'Send',
    ...
    'settings.authGroup': 'Authentication',
    'settings.authHint': 'Most providers use the same API key for chat and image generation.',
    'settings.chatGroup': 'Chat Capability',
    'settings.chatHint': 'Used for normal chat, vision Q&A, and auto topic naming.',
    'settings.chatApiUrl': 'Chat API URL',
    'settings.chatModel': 'Chat Model',
    'settings.imageApiUrl': 'Image Generation API URL',
    'settings.imageApiUrl.placeholder': 'https://api.openai.com/v1/images/generations',
    'settings.imageModel': 'Image Generation Model',
    'settings.imageModel.placeholder': 'Leave blank to reuse chat model',
    'settings.imageGroup': 'Image Capability',
    'settings.imageHint': 'If your provider has a separate image endpoint, fill it in here; otherwise leave it blank and try auto inference.',
    'settings.cancel': 'Cancel',
    'settings.save': 'Save Model',
    'settings.saveAll': 'Save',
    'settings.profileNew': '+ New Model Profile',
    'settings.edit': 'Edit',
    'settings.delete': 'Delete',
    'settings.noModel': 'No model configured',
    'settings.profileType': 'Type',
    'settings.profileName': 'Name',
    'settings.profileName.placeholder': 'Leave blank to show model name',
    'settings.profileName.desc': 'Leave blank to show model name',
    'settings.profileName.optional': 'Optional',
    'settings.gistToken.hintShort': 'Requires a token with gist permission',
    'settings.gistId.hintShort': 'Auto-created on first sync',
    'settings.gistId.placeholderShort': 'Auto-created',
    'settings.syncAction': 'Manual Sync',
    'settings.uploadShort': 'Upload',
    'settings.downloadShort': 'Download',
    'settings.import.desc': 'Restore chats and configs from JSON',
    'settings.importAction': 'Choose File',
    'settings.export.desc': 'Save all data as JSON',
    'settings.exportAction': 'Export',
    'settings.reset.desc': 'Clear chats, topics, and model configs',
    'settings.resetAction': 'Reset',
    'settings.profileFormHint': 'Each profile is either chat or image generation. Switch profiles from the top-right dropdown.',
    'profile.type.chat': 'Chat',
    'profile.type.image': 'Image',
    'profile.incomplete': 'The selected model profile is incomplete. Fill in the API URL and model.',

    // Send settings
    'settings.sendConfig': 'Send Settings',
    'settings.sendKey': 'Send Key',
    'settings.sendKey.desc': 'Choose which shortcut sends your message',
    ...
    'message.imageGenerated': 'Image generated.',
    'message.openImage': 'Open image in new tab',
    'message.popupBlocked': 'Popup blocked. Allow popups for this site and try again.',
    'message.noImagePrompt': 'Enter an image prompt or attach text files as reference.',
    'message.imageEndpointMissing': 'No image generation endpoint is configured for this model.',
    'message.noChatCapability': 'This model does not have a usable chat endpoint configured.',
    'message.attachReadFailed': 'Failed to read attachment: ',
    'message.attachTooMany': 'You can upload up to 5 attachments at a time.',
    'message.attachImageTooLarge': 'Image is too large. Keep it under 3MB.',
    'message.attachTextTooLarge': 'Text file is too large. Keep it under 200KB.',
    'message.attachEmpty': 'The selected attachment is empty or unreadable.',
    'message.binaryFileOnlyMeta': 'Binary files send filename, type, and size metadata only.',
    'message.fileLabel': 'File',
    ...
    'error.imageResponse': 'Image generation response is empty. Please confirm the endpoint is OpenAI Images compatible.',
    'error.profileChatIncomplete': 'To enable chat, fill in both the chat API URL and chat model.',
    'error.profileImageIncomplete': 'For an image-only profile, fill in both the image API URL and image model.',
    'error.profileNeedCapability': 'Configure at least one complete capability: chat or image generation.',
    'error.profileIncomplete': 'Please fill in both the API URL and model.',
    'error.storageUnavailable': 'This browser cannot write local storage, so settings and chats will be lost after refresh. This is a static site: data lives only in this browser\'s localStorage. Open it via https:// (not as a local file) and make sure private/incognito or cookie blocking is off.',
    'error.storageQuota': 'Local storage is full, so chat history could not be saved completely. Export a backup, clear old chats, or send fewer image attachments.',
  }
};
